...
variable "container_image" {
  ...
  type        = string
  default     = "docker.io/rajeshkr2025/learning-tracker:latest"
}
...
resource "aws_iam_role_policy" "ecs_task_execution_secrets" {
  name = "${var.project}-ecs-task-execution-secrets-${var.environment}"
...
resource "aws_appautoscaling_policy" "ecs_cpu" {
  name               = "${var.project}-cpu-autoscaling-${var.environment}"
...
resource "aws_appautoscaling_policy" "ecs_memory" {
  name               = "${var.project}-memory-autoscaling-${var.environment}"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.ecs.resource_id
  scalable_dimension = aws_appautoscaling_target.ecs.scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs.service_namespace
